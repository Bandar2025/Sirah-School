...
export default function FirstRunWizard({ onComplete }: FirstRunWizardProps) {
  ...
  const steps = [
    {
      title: 'مرحباً بك في نظام المنارة',
    ...
    {
      title: 'الإدارة والإعداد النهائي',
      description: 'إدخال بيانات مدير المدرسة وبدء تشغيل النظام.',
        ...
        <div className="p-8 min-h-[300px]">
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                <div className="py-8">
                  <p className="text-slate-600 mb-4">أهلاً بك في النسخة النهائية من نظام المنارة ERP.</p>
              ...
              >
                ...
                <div className="p-4 bg-indigo-50 border border-indigo-200 rounded-xl">
                  <p className="text-xs text-indigo-800 leading-relaxed font-medium">
                    مبروك! نظام المنارة ERP جاهز للعمل. بمجرد الضغط على زر البدء، سيتم توجيهك إلى شاشة تسجيل الدخول.
                  </p>
                </div>
              </motion.div>
            )}
